...
var a=Ember.Service.extend({init:function(){this._super.apply(this,arguments),this.violations=Ember.A()},auditWithAxe:function(){var e=o(regeneratorRuntime.mark(function e(r){var i,o,a,s
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return i=n.default["ember-accessibility"].axe,o=void 0===i?{}:i,e.next=3,t.default.run(r,o)
case 3:return a=e.sent,s=[],a.violations.length&&a.violations.forEach(function(e){1===e.nodes.length?s.push(e):e.nodes.forEach(function(t,n){var r={index:n}
